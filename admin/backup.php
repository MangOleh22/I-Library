...
if (isset($_SESSION['start_time'])) {
    ...
    if ($elapsed_time >= $timeout) {
        session_destroy();
        echo "<script>alert('Sesei Anda Telah Habis!'); window.location = '$logout_redirect_url'</script>";
    }
}
                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            <div class="panel">
                                ...
                                <h3><b>Untuk menghindari hilangnya data, Back Up Database ILibrary secara berkala.</b></h3>
                                    <?php
