...
<head>
    <meta charset="UTF-8">
    <title>I-Library (Library Management System)</title>
    <meta content='width=device-width, initial-scale=1, maximum-scale=1, user-scalable=no' name='viewport'>
    <meta name="description" content="Library Management System Berbasis Web">
...
tanggallengkap = namahari[hari] + ", " +tanggal + " " + namabulan[bulan] + " " + tahun;
    ...
    <!-- WARNING: Respond.js doesn't work if you view the page via file:// -->
      ...
      <body class="skin-black">
		...
		<b>Selamat Datang di I-Library (Library Management System), Untuk Login Admin silahkan klik Icon User atau klik <a href="login.html">disini</a></b>
          </div>
            </div>
...
<div class="modal fade" id="contact" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      I-Library adalah website perpustakaan yang responsif, I-Libry Versi ini adalah versi untuk info, saran, maupun kritik bisa menghubungi
      Kelompok 4 :
      <table>
      <tr>
      <td>No Telepon</td> <td>:</td> <td>0888888812112</td>
      </tr>
      <br />
      <tr>
